...
namespace OuterWildsKazoo
{
    public class OuterWildsKazoo : ModBehaviour
    {
        ...
        private void Start()
        {
            endCredits = ModHelper.Assets.GetAudio("OW End Credits 022019_3 AP.mp3");
            flashbackSlam = ModHelper.Assets.GetAudio("OW NM Flashback 081718 AP slam.mp3");
            flashbackLoop = ModHelper.Assets.GetAudio("OW NM Flashback 082818 AP loop.mp3");
            flashbackOverlay1 = ModHelper.Assets.GetAudio("OW NM Flashback 082818 AP overlay1.mp3");
            flashbackLoopOverlay = ModHelper.Assets.GetAudio("OW NM Flashback 082818 loop overlay AP.mp3");
            flashbackStingerDelayed = ModHelper.Assets.GetAudio("OW NM Flashback 082818_2 AP stinger delayed.mp3");
            flashbackStinger = ModHelper.Assets.GetAudio("OW NM Flashback 082818_2 AP stinger.mp3");
            flashbackBase = ModHelper.Assets.GetAudio("OW NM Flashback 082818_3 AP base.mp3");
            sadTheme = ModHelper.Assets.GetAudio("OW_NM_SadTheme_older.mp3");
            skypeLP = ModHelper.Assets.GetAudio("OW_NM_SkypeLP.mp3");
            vesselDiscovery = ModHelper.Assets.GetAudio("OW_NM_VesselDiscovery.mp3");
            poolEnter = ModHelper.Assets.GetAudio("Pool_Enter_v3_Fade.mp3");
            poolExit = ModHelper.Assets.GetAudio("Pool_Exit_v3.mp3");
            eyeOfTheUniverse = ModHelper.Assets.GetAudio("OW Eye Of The Universe 082018_2 AP.mp3");
            darkBramble = ModHelper.Assets.GetAudio("OW_DarkBramble_loop.mp3");
            endTimes = ModHelper.Assets.GetAudio("OW_EndTimes.mp3");
            endTimesMuted = ModHelper.Assets.GetAudio("OW Muted End Times 040821 AP.mp3");
            finalEndTimesDBLoop = ModHelper.Assets.GetAudio("OW_FinalEndTimes_DB_loop.mp3");
            finalEndTimesLoop1 = ModHelper.Assets.GetAudio("OW Final End Times 022519_2 AP LOOP1.mp3");
            finalEndTimesLoop2 = ModHelper.Assets.GetAudio("OW Final End Times 022519_2 AP LOOP2.mp3");
            giantsDeep = ModHelper.Assets.GetAudio("OW Aquatic Exploration 050318 AP LOOP.mp3");
            letThereBeLight = ModHelper.Assets.GetAudio("OW END OF GAME 021818 AP.mp3");
            mainMenu = ModHelper.Assets.GetAudio("OW_Main_Menu.mp3");
            terribleFate = ModHelper.Assets.GetAudio("ow_kazoo_theme.mp3");
            morning = ModHelper.Assets.GetAudio("OW Morning Cello 101718_2.mp3");
            nomaiRuins = ModHelper.Assets.GetAudio("OW NM Nomai Ruins 081718 AP.mp3");
            nomaiRuinsMotif1c = ModHelper.Assets.GetAudio("OW NomaiRuinsRegular 081918 AP motif1c.mp3");
            nomaiRuinsMotif2c = ModHelper.Assets.GetAudio("OW NomaiRuinsRegular 081918 AP motif2c.mp3");
            nomaiRuinsMotif3c = ModHelper.Assets.GetAudio("OW NomaiRuinsRegular 081918 AP motif3c v2.mp3");
            nomaiRuinsMotif4c = ModHelper.Assets.GetAudio("OW NomaiRuinsRegular 081918 AP motif4c.mp3");
            nomaiRuinsMotif5c = ModHelper.Assets.GetAudio("OW NomaiRuinsRegular 081918 AP motif5c v2.mp3");
            nomaiRuinsMotif6c = ModHelper.Assets.GetAudio("OW NomaiRuinsRegular 081918 AP motif6c.mp3");
            nomaiRuinsMotif7c = ModHelper.Assets.GetAudio("OW NomaiRuinsRegular 081918 AP motif7c.mp3");
            space = ModHelper.Assets.GetAudio("OW_Travel_Theme_Remaster.mp3");
            atp = ModHelper.Assets.GetAudio("OW Nomai Time Loop Device 081818 AP.mp3");
            museum = ModHelper.Assets.GetAudio("OW_TH_Museum.mp3");
            nomaiCity = ModHelper.Assets.GetAudio("OW NM Nomai City 081718 AP LOOP.mp3");
            theSearch = ModHelper.Assets.GetAudio("OW_NM_Tech_Advanced.mp3");
            sunStation = ModHelper.Assets.GetAudio("OW_NM_SunStation.mp3");
            eyeOfTheUniverse2 = ModHelper.Assets.GetAudio("OW Eye Of The Universe 082818_2 AP.mp3");
            quantumMoon = ModHelper.Assets.GetAudio("OW_QuantumMoon.mp3");
            quantumSignal = ModHelper.Assets.GetAudio("OW_QuantumSignal.mp3");
            timberHearth = ModHelper.Assets.GetAudio("Hearth Village.mp3");
            travelerBanjo = ModHelper.Assets.GetAudio("OW_TravelerTheme_banjo.mp3");
            travelerDrums = ModHelper.Assets.GetAudio("OW_TravelerTheme_drums.mp3");
            travelerFlute = ModHelper.Assets.GetAudio("OW_TravelerTheme_flute.mp3");
            travelerHarmonica = ModHelper.Assets.GetAudio("OW_TravelerTheme_harmonica.mp3");
            travelerPiano = ModHelper.Assets.GetAudio("OW_TravelerTheme_piano.mp3");
            travelerWhistling = ModHelper.Assets.GetAudio("OW_TravelerTheme_whistling.mp3");
            travelerThemeNoPiano = ModHelper.Assets.GetAudio("OW Traveler Theme 091118 AP FINAL TIME NO PIANO EDIT.mp3");
            travelerTheme = ModHelper.Assets.GetAudio("OW Traveler Theme 091118 AP FINAL TIME WITH PIANO EDIT.mp3");
            hideAndSeek = ModHelper.Assets.GetAudio("CampfireTune_All_Reverb.mp3");
            distressBeacon = ModHelper.Assets.GetAudio("OW_NM_EscapePodDistressSignal.mp3");
            banjoStrum1b = ModHelper.Assets.GetAudio("OW_PR_BanjoStrum_1b.mp3");
            banjoStrum2b = ModHelper.Assets.GetAudio("OW_PR_BanjoStrum_2b.mp3");
            banjoStrum3b = ModHelper.Assets.GetAudio("OW_PR_BanjoStrum_3b.mp3");
            banjoStrum4b = ModHelper.Assets.GetAudio("OW_PR_BanjoStrum_4b.mp3");
            interloper = ModHelper.Assets.GetAudio("Ice_Cave_Amb_loop_v3_01.mp3");
            scout = ModHelper.Assets.GetAudio("OW_PR_ProbeInAirSound.mp3");
            ancientGlade = ModHelper.Assets.GetAudio("Ancient Glade.mp3");
